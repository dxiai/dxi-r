...
Die Funktionen der Bibliothek `purrr` oder deren Schwesterbibliothek `furrr` sind der einfachste Weg in R das Verhalten Schleifen funktional umzusetzten. Dabei sind zwei Funktionen zentral: 
